...
sound(result(4.25e6:4.3e6)/3,fs);
ylim([-3.5,3.5])
pause(10)
...
sound(source(4.25e6:4.3e6)/3,fs)
ylim([-3.5,3.5])
pause(10)
...
ylim([-3.5,3.5])
soundsc(result2(4.25e6:4.3e6),fs);
pause(10)
...
title('Original Waveform')
ylim([-3.5,3.5])
soundsc(source(4.25e6:4.3e6),fs)
